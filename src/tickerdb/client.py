...
class TickerDB:
    ...
    def create_team(self, name: str) -> Dict[str, Any]:
        ...
        """
        return self._team_action("create", name=name)
    ...
    def invite_member(
        ...
        """
        return self._team_action("invite", team_id=team_id, email=email, role=role)
    ...
    def remove_member(self, team_id: str, user_id: str) -> Dict[str, Any]:
        ...
        """
        return self._team_action("remove_member", team_id=team_id, user_id=user_id)

    def cancel_invite(self, team_id: str, invite_id: str) -> Dict[str, Any]:
        ...
        """
        return self._team_action("cancel_invite", team_id=team_id, invite_id=invite_id)

    def resend_invite(self, team_id: str, invite_id: str) -> Dict[str, Any]:
        ...
        """
        return self._team_action("resend_invite", team_id=team_id, invite_id=invite_id)
    ...
    def promote_member(
        ...
        """
        return self._team_action(
            "promote", team_id=team_id, user_id=user_id, role=role
        )

    def leave_team(self, team_id: str) -> Dict[str, Any]:
        ...
        Args:
            team_id: The team ID.
        """
        return self._team_action("leave", team_id=team_id)

    def rename_team(self, team_id: str, name: str) -> Dict[str, Any]:
        ...
        """
        return self._team_action("rename", team_id=team_id, name=name)

    def set_seats(self, team_id: str, total_seats: int) -> Dict[str, Any]:
